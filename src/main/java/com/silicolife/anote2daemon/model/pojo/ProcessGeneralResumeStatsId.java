...
public class ProcessGeneralResumeStatsId implements java.io.Serializable {
	...
	public ProcessGeneralResumeStatsId(long processesIdprocesses, String type, long numberType) {
	...
	public boolean equals(Object other) {
		...
		return (this.getProcessesIdprocesses() == castOther.getProcessesIdprocesses()) && ((this.getType() == castOther.getType()) || (this.getType() != null && castOther.getType() != null && this.getType().equals(castOther.getType())))
