...
public class ProcessEntitiesStatsId  implements java.io.Serializable {
    ...
    public ProcessEntitiesStatsId(long processesIdprocesses, long count(element), String class_) {
        this.processesIdprocesses = processesIdprocesses;
        this.count(element) = count(element);
        this.class_ = class_;
    }
    public ProcessEntitiesStatsId(long processesIdprocesses, String element, long count(element), String class_) {
       this.processesIdprocesses = processesIdprocesses;
    ...
    public long getCount(element)() {
        return this.count(element);
    }
    
    public void setCount(element)(long count(element)) {
        this.count(element) = count(element);
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ProcessEntitiesStatsId) ) return false;
 ...
 && (this.getCount(element)()==castOther.getCount(element)())
 && ( (this.getClass_()==castOther.getClass_()) || ( this.getClass_()!=null && castOther.getClass_()!=null && this.getClass_().equals(castOther.getClass_()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + (int) this.getCount(element)();
