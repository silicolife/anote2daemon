...
public class AnnotationDocumentServerImpl extends PublicationServerImpl implements IAnnotatedDocument{
	...
	public AnnotationDocumentServerImpl(IPublicationsService publicationService,IPublication document,IIEProcess reProcess, ICorpus corpus) {	
		super(publicationService,document);
		this.corpus=corpus;
	...
	public AnnotationDocumentServerImpl(IPublicationsService publicationService, IAnnotatedDocument anoteDocument) {
		this(publicationService, new PublicationServerImpl(publicationService, anoteDocument), anoteDocument.getProcess(), anoteDocument.getCorpus());
	}
